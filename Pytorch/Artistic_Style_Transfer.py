# -*- coding: utf-8 -*-
"""Artistic Style Transfer.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SkGdfBuhWIR8KNRyQQzsdTQdVlNRu8bi
"""
"""
Practice Project, original project from Pytorch examples, minor changes made to it 
"""
...
imsize = 444  # desired size of the output image
...
def image_loader(image_name):
    image = Image.open(urlopen(image_name))
...
style = image_loader("https://pytorch.org/tutorials/_static/img/neural-style/picasso.jpg").type(dtype)
content = image_loader("https://i.imgur.com/mMLKyly.jpg").type(dtype)
...
input = image_loader("https://i.imgur.com/mMLKyly.jpg").type(dtype)
